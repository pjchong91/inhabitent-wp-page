	...
	<body <?php body_class(); ?>>
		<div id="page" class="hfeed site">
			...
			<span class="icon-search" aria-hidden="true">
				<i class="fa fa-search dark-icon"></i>
			</span>
			<span class="screen-reader-text"><?php echo esc_html( 'Search' ); ?></span>
		</button>

		<label>
			<input type="search" class="search-field dark-text" placeholder="Type and hit enter..." value="<?php echo esc_attr( get_search_query() ); ?>" name="s" title="Search for:" />
		</label>
